...
This fork modernizes Learning Locker via a strangler path. Lab dual-run uses
**Node 10** on `ll-legacy` and **Node 20** on `ll-modern` while `.nvmrc` remains
`10` for upstream parity — see [lab/README.md](lab/README.md).
