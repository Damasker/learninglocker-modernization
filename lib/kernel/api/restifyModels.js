...
export const RESTIFY_V2_MODELS = [
  ...
  { modelName: 'LRS', restify: true, connections: true, indexes: true, notes: 'GET strangler behind ENABLE_NATIVE_LRS_ROUTER; writes remain on restify' },
  {
    ...
    connections: true,
    indexes: true,
    notes: 'GET strangler behind ENABLE_NATIVE_STATEMENT_ROUTER; create/update blocked (405); delete gated by ENABLE_STATEMENT_DELETION',
  },
  ...
  { modelName: 'SiteSettings', restify: true, connections: false, indexes: false, notes: 'GET strangler behind ENABLE_NATIVE_SITE_SETTINGS_ROUTER; scope filter is {}' },
  {
    ...
    connections: true,
    indexes: true,
    notes: 'GET strangler behind ENABLE_NATIVE_BATCH_DELETE_ROUTER; create/update/delete blocked (405); mutations via batch-delete controllers',
  },
];
