...
// Restify Statement model paths (distinct from /statements/aggregate* analytics)
export const STATEMENT_REST = `${RESTIFY_PREFIX}/statement`;
export const STATEMENT_REST_ID = `${RESTIFY_PREFIX}/statement/:id`;
